...
var AdminRouter = /** @class */ (function (_super) {
    ...
    function AdminRouter(db, app) {
        return _super.call(this, db, app) || this;
    }
    AdminRouter.prototype.init = function () {
        var _this = this;
        var router = express_1.default.Router();
        this.app.use(subdomain('*', router));
        router.get('/admin/config', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var sub, user, calc, e_1;
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _b = (_a = res).send;
                        return [4 /*yield*/, this.db.getAuthToken(sub, user, pass)];
                    case 1:
                        _b.apply(_a, [_c.sent()]);
                        return [3 /*break*/, 3];
                    case 2:
